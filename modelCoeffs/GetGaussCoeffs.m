...
%           - ``'MagFldJupiterJRM33'``: "A New Model of Jupiter's Magnetic Field at the Completion
%             of Juno's Prime Mission." https://doi.org/10.1029/2021JE007138 The Jupiter Reference
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    switch(planet)
        ...
        case 'Jupiter'
            switch(InternalFieldModel)
                case 'MagFldJupiterVIP4'
                    % Connerney1998, New models of Jupiter's magnetic field constrained by the Io
                    % flux tube footprint
                    % Interior field parameters (Schmidt semi-normalized coefficients) in Gauss
                ...
                case 'MagFldJupiterGSFCO4'
                    ...
                    % Note that as the original publication used SIII (1957) coordinates, these
                    % values were updated to SIII (1965) coordinates by Acuna et al. (1983), as
                ...
                case 'MagFldJupiterJRM33'
                    % Connerney2020, A New Model of Jupiter's Magnetic Field at the Completion of
                    % Juno's Prime Mission
                    % JRM09: Juno Reference Model through perijove 33, on 2021-04-15
                    % "The degree 1 coefficients of the JRM33 model describe a dipole with moment
                    % M = 4.177 G, offset from the rotation axis by theta_d = 10.25 deg towards
                    % System III longitude of phi_d = 196.38 deg. Differences with the previous
                    % JRM09 model dipole (Delta M = 0.007 G, Delta theta_d = 0.06 deg, 
        ...
        otherwise
            error(['Planet name "' planet '" not recognized. Options are Jupiter, Saturn, ' ...
                'Uranus, Neptune.'])
